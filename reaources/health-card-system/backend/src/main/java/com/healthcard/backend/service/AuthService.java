...
public class AuthService {
    ...
    public AuthResponse registerDoctor(RegisterDoctorRequest req) {
        ...
        notificationService.notifyUser(user, "Registration successful",
                "Your doctor account has been verified automatically. " +
                        "You can now access patient records.");
    ...
    public AuthResponse registerPathologist(RegisterPathologistRequest req) {
        ...
        notificationService.notifyUser(user, "Registration successful",
                "Your pathologist account has been verified automatically.");
